<template>
  <div class="px-6 py-6 pt-4 lg:pl-24 lg:pt-10 w-full lg:w-7/12">
    ...
    <form>
      ...
      <div class="flex items-end justify-between">
        ...
        <!-- section button -->
        <div class="flex h-12 justify-end lg:pb-3 lg:pr-8">
          <button
            type="button"
            ...
            class="flex items-center border mx-6 font-bold focus:outline-none rounded py-2 px-4"
            @click="goBack"
          >
            <svg
          ...
          <button
            type="button"
            class="flex items-center border font-bold focus:outline-none text-green-800 border-green-800 rounded py-2 px-4"
            @click="submitForm"
          >
            Lanjut
            <svg
